      ...
      <div className="d-flex justify-content-between align-items-end mb-4">
        <div>
          ...
          <p className="text-muted mb-0">
            Theo dõi hoạt động, người dùng và doanh thu của toàn nền tảng.
          </p>
        </div>
        <div>
          <button
          ...
          <div className="card border-0 shadow-sm rounded-4 h-100">
            <div className="card-body p-4 d-flex align-items-center">
              ...
              <div>
                ...
                <small className="fw-medium" style={{ color: "#10b981" }}>
          ...
          <div className="card border-0 shadow-sm rounded-4 h-100">
            <div className="card-body p-4 d-flex align-items-center">
              ...
              <div>
                ...
                <small className="fw-medium" style={{ color: "#10b981" }}>
                  <i className="bi bi-arrow-up-short"></i> +12 user mới
                </small>
              </div>
            </div>
          </div>
            ...
            <div className="card-body p-4 d-flex align-items-center">
              ...
              <div>
                ...
                <small className="text-danger fw-medium">
                  <i className="bi bi-exclamation-circle"></i> Cần xử lý
                </small>
              </div>
            </div>
          </div>
          ...
          <div className="card border-0 shadow-sm rounded-4 h-100">
            <div className="card-body p-4 d-flex align-items-center">
              ...
              <div>
                ...
                <small className="fw-medium" style={{ color: "#10b981" }}>
                  <i className="bi bi-arrow-up-short"></i> +8.5%
                </small>
              </div>
            </div>
          </div>
      ...
      <div className="row g-4 mb-4">
        ...
        <div className="col-lg-7">
          <div className="card border-0 shadow-sm rounded-4 h-100 p-4">
            ...
            {/* Giả lập biểu đồ */}
            <div
              className="bg-light rounded-3 d-flex flex-column justify-content-center align-items-center"
              style={{ minHeight: "300px" }}
            >
              <div
                className="w-100 px-4 d-flex align-items-end justify-content-between"
                style={{ height: "200px" }}
              >
                <div
                  className="rounded-top opacity-75"
                  style={{
                    width: "8%",
                    height: "40%",
              ...
              <p className="mt-3 text-muted small">
                Khu vực tích hợp Biểu đồ Recharts
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="card border-0 shadow-sm rounded-4 h-100 p-0 overflow-hidden">
            ...
            <div className="p-3 bg-light text-center mt-auto border-top">
              <a
                ...
                style={{ color: "#4f46e5" }}
              >
                Đi tới trang Kiểm duyệt <i className="bi bi-arrow-right"></i>
              </a>
            </div>
          </div>
        </div>
