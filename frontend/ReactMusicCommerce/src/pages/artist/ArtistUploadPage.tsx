          ...
          <div className="card border-0 shadow-sm rounded-4">
            <div className="card-body p-4">
              ...
              <p className="text-muted small mb-4">
                Các thông số này giúp thuật toán AI và công cụ tìm kiếm đề xuất
                bài hát của bạn chính xác hơn.
              </p>
              ...
              <div className="row g-3">
                ...
                <div className="col-md-4">
                  <label className="form-label fw-medium">Nhịp độ (BPM)</label>
            ...
            <div className="card-body p-4">
                ...
                <div className="form-check form-switch d-flex justify-content-between ps-0 align-items-center">
                  <div>
                    ...
                    <p className="small text-muted mb-0">
                      Tự động chèn âm thanh "AudioJungle" vào bản nghe thử để
                      chống quay lén.
                    </p>
                  </div>
                  <input
              ...
              <div className="mb-3">
                <label className="form-label fw-bold d-flex align-items-center">
                  <i className="bi bi-person-fill me-2 text-info"></i> Giấy phép
                  Cá nhân
                </label>
              ...
              <div className="mb-3">
                <label className="form-label fw-bold d-flex align-items-center">
                  <i className="bi bi-briefcase-fill me-2 text-danger"></i> Giấy
                  phép Thương mại
                </label>
                <p className="small text-muted mb-2">
